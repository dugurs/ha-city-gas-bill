...
-   **유연한 검침 주기 지원**: `매월` 검침뿐만 아니라, `격월(홀수/짝수월)` 또는 `3개월(분기별)` 검침 주기를 완벽하게 지원합니다. 정기(격월/3개월) 주기 선택 시, 해당 기간의 사용량과 요금을 합산하여 보여주는 전용 센서들이 자동으로 추가됩니다.
...
| **전월 사용 요금** | 지난달의 최종 확정 요금입니다. |
| **전전 사용 요금** | 2달 전의 최종 확정 요금입니다. |
...
-   **신규 공급사 추가**: 삼천리, 대륜이엔에스, 참빛충북도시가스 공급사를 추가했습니다.
